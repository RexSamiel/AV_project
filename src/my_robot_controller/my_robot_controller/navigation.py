...
class TurtleNavigationNode(Node):
    def __init__(self):
        ...
        self.goal_poses.append({'x': 0.0, 'y': 0.0, 'yaw': -30})
        self.goal_poses.append({'x': 2.8, 'y': 5.9, 'yaw': -60})
        self.goal_poses.append({'x': -5.05, 'y': 3.88, 'yaw': 0})
        self.goal_poses.append({'x': -1.2, 'y': 3.7, 'yaw': 90})
